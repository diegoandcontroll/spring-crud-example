...
import com.api.parkingcontrol.config.Message;
...
public class ParkingSpotController {
  ...
  public ResponseEntity<Object> create(@RequestBody @Valid ParkingSpotDto parkingSpotDto) {
    ...
    parkingSpotModel.setBrandCar(parkingSpotModel.getBrandCar().toUpperCase());
    parkingSpotModel.setRegistrationDate(LocalDateTime.now(ZoneId.of("UTC")));
    return ResponseEntity.status(HttpStatus.CREATED).body(parkingSpotService.save(parkingSpotModel));
  }

  @GetMapping
  public ResponseEntity<Page<ParkingSpotModel>> findAllParkingSpots(
  ...
  public ResponseEntity<Object> getOneParkingSpot(@PathVariable(value = "id") UUID id) {
    Optional<ParkingSpotModel> parkingSportModelOptional = parkingSpotService.findById(id);
  ...
  public ResponseEntity<Object> deleteParkingSpot(@PathVariable(value = "id") UUID id) {
    ...
    return ResponseEntity.status(HttpStatus.OK).body(new Message("Parking control deleted"));
  }
